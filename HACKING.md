...
hidden if the `CassouScript_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `CassouScript_DEVELOPER_MODE` to the configure
...
Runs the executable target `CassouScript_exe`.
